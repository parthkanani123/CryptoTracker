...
/*
 ...
 - To convert below JSON Response, go to https://app.quicktype.io and paste the JSON Response and you get the model.
...
struct Coin: Identifiable, Codable 
{
    ...
    // our model consist of camelCase but the JSON of snake_case so we have to create codingKey for successful decoding.
